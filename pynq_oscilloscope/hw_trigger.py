...
class HardwareTrigger:
    ...
    hysteresis, auto-timeouts, and oscilloscope modes.
    """
    ...
    def __init__(self, overlay_or_mmio: Union[object, MMIO], clock_freq_hz: int = 100_000_000):
        ...
        # Apply default state: 1.65V Threshold, Auto Mode, Rising Edge, Trigger on CH1 (A0)
        self.configure(
            mode="Auto",
            edge="Rising",
            source="CH1",
    ...
    def __repr__(self) -> str:
        ...
        return f"<HardwareTrigger: {armed}, Source={src}, Mode={mode}, Edge={edge}, Threshold={thresh:.2f}V>"